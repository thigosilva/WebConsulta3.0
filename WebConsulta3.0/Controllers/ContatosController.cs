...
namespace WebConsulta3._0.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Telefone,Email")] Contatos contatos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Telefone,Email")] Contatos contatos)
        {
            if (id != contatos.Id)
            {
                return NotFound();
